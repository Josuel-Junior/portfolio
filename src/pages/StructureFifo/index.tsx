...
export const StructureFifo: React.FC = () => {
  ...
  const handleAddArrayFila = () => {
    if (arrayFila.length <= 5) {
      setArrayFila((prev) => [
        ...prev,
        (prev.length > 0 ? prev[prev.length - 1] : 0) + 1,
      ]);
    }
  };
  ...
  return (
    <>
      ...
      <Box sx={{ my: "20px" }} id="structureFila">
        <Container>
          ...
          <Typography paragraph>
            ...
            representar visualmente a estrutura de dados de uma Fila, Nesta
            seção, vou explicar o funcionamento dessa estrutura, e em seguida,
            você poderá visualizá-la de forma gráfica.
          </Typography>
          <Typography paragraph>
            Veja também sobre a estrutura de Pilha{" "}
            <Button onClick={handleNavigateLifo}>ver sobre</Button>
          </Typography>
          <Typography paragraph>
            Uma fila é uma coleção ordenada de itens baseada em FIFO (First In
            First Out, isto é, o primeiro que entra é o primeiro que sai) A
            operação de adição de novos elementos em uma fila ocorre no final da
            fila, também conhecido como "cauda" (tail), enquanto a remoção de
            elementos ocorre na frente da fila.
          </Typography>
          <Typography paragraph>
            Um exemplo seria a fila de uma lotérica, onde o primeiro cliente a
            chegar será o primeiro a ser atendido, enquanto o último da fila
            será o último a ser atendido. A cada cliente atendido, o cliente
            anterior se torna o próximo a ser atendido e, com isso, o próximo a
            sair da fila.
          </Typography>
          <Typography paragraph>
            Vamos criar nossa estrutura de Fila baseada em Array, e a linguagem
          ...
          <Typography paragraph>
            ...
            adição de novos elementos na pilha, Esse método será responsável
            pela adição de novos elementos na fila, com um detalhe muito
            importante: só podemos adicionar novos itens no final da fila. O
            método push é representado assim:
          </Typography>
          ...
          <Typography paragraph>
            O método shift é responsável pela remoção de itens da fila. Como a
            fila utiliza o princípio FIFO, o primeiro item adicionado é aquele
            que será removido. Por esse motivo, podemos usar o método shift da
            classe Array.
          </Typography>
          <Typography paragraph sx={{ fontWeight: "bold" }}>
      ...
      >
        ...
        <Box>
          <Button variant="contained" onClick={() => handleAddArrayFila()}>
            Inserir{" "}
          </Button>
          <Button
            variant="contained"
            onClick={() => handleRemoveArrayFila()}
            sx={{ mx: "5px" }}
          >
            Remover
          </Button>
