...
export const DisplayTechnologies: React.FC<pagination> = ({
  showPagination,
  ...
  return (
    ...
    >
      <Grid
        ...
        sx={{ my: "25px", display: "flex", justifyContent: "center" }}
      >
      ...
      <Box>
        {showPagination && (
          <Stack spacing={2} sx={{ marginY: "20px" }}>
            <Pagination
              count={Math.ceil(data.allServiceIcons.length / itemsPerPage)}
              color="primary"
              page={currentPage}
