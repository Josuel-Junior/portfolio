...
export const DisplayProjects: React.FC<numberOfDisplay> = ({
  showPagination,
}) => {
  ...
  const filteredData = data.allProjects?.filter((item: IDataprojects) =>
    item.projecttype
      .toLocaleLowerCase()
